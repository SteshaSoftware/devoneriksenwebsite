...
export const TheftofFire = {
    ...
    Backers: [`Dan Paddock`,
        ...
        `PJ`,
        `Alex Holden`,
        `Walker America, host of "THE Bitcoin Podcast"`,
        `Servaya`,
        `Justin Elias`,
        `Kevin Cogan`,
        `Aaron Feingold`,
        ...
        `Aaron & Andrell Laniewicz`,
        `Jason Andersen`,
        `Marve king`,
        `Максим Стоялов DENAMAX`,
        `John Jolly`,
        `MarcGee`,
        `noem4`,
        `Christian Pekeler`,
        ...
        `Man of the Atom`,
        `Johnathan Nutini`,
        `Garrett Friedeck and family`,
        `David Hellam`,
        `Jean F. Queralt from The IO Foundation`,
        `Jorge Sawyer`,
        `Tim Davidson`,
        `Michael Litsey`,
        `Kristy M`,

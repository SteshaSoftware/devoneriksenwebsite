        ...
        <div style={{ width: "70%", marginLeft: "auto", marginRight: "auto", marginTop: "50px" }}>
            ...
            <Grid container sx={{ marginTop: 1, marginBottom: 30 }} justifyContent={"center"} spacing={4}>
                <Grid item xs={12} md={6}>
                    <a href="https://bookcon.book.io/" onClick={() => window.sa_event('event')}>
                        <div data-aos="zoom-out-right" className='p-3 rounded-xl event-card   '>
                            <Typography variant='body1' sx={{ color: "#b79cff", fontSize: 20, fontWeight: "bold" }}>04/20</Typography>
                            <Typography variant='small' sx={{ color: "#ff9b02", fontSize: 20 }}>Book.io Con McKinney, TX</Typography>
                        </div>
                    </a>
                </Grid>
                <Grid item xs={12} md={6}>
                ...
                <Grid item xs={12} md={6}>
                    <a href="https://writerscantina.org/" onClick={() => window.sa_event('event')}>
                        <div data-aos="zoom-out-right" className='p-3 rounded-xl event-card '>

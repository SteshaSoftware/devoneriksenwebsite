...
export const DarkLighthouse = {
  title: `A lighthouse makes light; so just for a lark, I built me a darkhouse. A darkhouse makes dark.`,
  content:  `Since before man had memory, the Obelisks of Light have stood upon the shores of the Sunset Ocean, jutting from clifftops, from rocky promontories, from the coastal swamps and the pristine white sands of far west Nymeria.
  <br /><br />
